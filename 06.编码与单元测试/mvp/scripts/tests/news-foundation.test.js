...
const { createAuthorizationStore, createAuthorizationTask, decideAuthorization } = require('../core/news-authorization');
const { historicalPageToken } = require('../pipeline/build-news');
const { validateSource, importSources, parseArgs, optionalNumber } = require('../cli/news-cli');
