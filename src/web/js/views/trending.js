...
import { showModal, closeModal, setModalScrollPosition } from '../ui/modal.js';
import { getFilteredTrending, getHotspotHeat } from '../data/data-filters.js';
import {
  escapeHtml,
  safeExternalUrl,
  timeAgo,
...
import { ICON_CLOSE, ICON_EXTERNAL } from '../ui/ui-icons.js';
import { getToolCardItem, getToolLevel3Item } from '../data/data-catalog.js';
import { t, getLocalizedField } from '../ui/i18n.js';
