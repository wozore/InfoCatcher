- [2026-07-28 · B18 · 代码结构优化](#2026-07-28--b18--代码结构优化)
- [2026-07-29 · 项目架构重构](#2026-07-29--项目架构重构)
- [2026-07-29 · 文档收束与导航修复](#2026-07-29--文档收束与导航修复)
- [2026-07-30 · GitHub Pages 部署修复](#2026-07-30--github-pages-部署修复)
...
- [docs/lifecycle/01-problem-definition/](docs/lifecycle/01-problem-definition/)
...
- [docs/lifecycle/02-feasibility/](docs/lifecycle/02-feasibility/)
...
- [docs/lifecycle/03-requirements/](docs/lifecycle/03-requirements/)
- [docs/lifecycle/04-architecture/](docs/lifecycle/04-architecture/)
- [开发计划.md](开发计划.md)
...
- 首次建立 [module-map.md](docs/architecture/module-map.md) 和 [mvp-architecture.drawio](docs/architecture/diagrams/mvp-architecture.drawio)。
...
- 将 [module-map.md](docs/architecture/module-map.md) 从 v0.2 更新为 v0.3，补齐六视图、构建时管线、持久状态、测试和 CI/CD。
- 更新 [mvp-architecture.drawio](docs/architecture/diagrams/mvp-architecture.drawio)，明确外部来源、Actions 构建、平台适配、Registry/调度/额度/授权、静态数据和浏览器运行时之间的关系。
- 修正 `index.html` 工具数量的静态初值：26 → 43；运行时仍由 `renderTools()` 按筛选结果更新。
- 重整本开发日志，补齐 S1、部署拆仓和 B14 两轮工作，删除已经过时的“25个工具”“尚未部署”等计划性叙述。

### 说明

- 原日志中的问题定义、可行性方法、瀑布与敏捷比较属于教程/复盘，不适合作为按时间维护的开发日志正文；对应细节继续由 [docs/lifecycle/01-problem-definition/](docs/lifecycle/01-problem-definition/)、[docs/lifecycle/02-feasibility/](docs/lifecycle/02-feasibility/) 和生命周期 Skill 保存。
...
- [x] 将项目从 `06.编码与单元测试/mvp/` 嵌套结构迁移为四层终局结构：源码(`src/`)、架构事实(`docs/architecture/`)、开发过程(`docs/lifecycle/`)、AI 入口(`.claude/`)
...
- [x] 将可行性研究中的 R2、R4 风险缓解材料收束为 [04-05.风险缓解方案.md](docs/lifecycle/02-feasibility/04-05.风险缓解方案.md)，保留风险评分、措施、执行清单、决策关口和原文件迁移映射。
- [x] 将 YouTube、X、Bilibili、知乎四份平台采集材料收束为 [06.平台数据采集综述.md](docs/lifecycle/02-feasibility/06.平台数据采集综述.md)，保留配额、成本、风险、流程、待办与原始状态；Bilibili 的旧自动化路线明确标注为历史候选，当前人工精选边界置于文档开头。
- [x] 将通用可行性研究方法论文档移动至 [docs/methodology/](docs/methodology/)，更新可行性报告引用；移动前后文件 SHA-256 一致。
